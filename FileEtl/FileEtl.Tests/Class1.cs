...
namespace FileEtl.Tests
{
    public class Class1
    {
        ...
        public void Test()
        {
            ...
            var etlPipelineConfiguration = new List<EtlStepconfiguration>
            {
                new EtlStepconfiguration{ StepType = typeof(SingleFileLoaderStep), Config = fileReaderConfig},
                new EtlStepconfiguration{ StepType = typeof(CsvReaderEtlStep), Config = csvConfig}
            };
