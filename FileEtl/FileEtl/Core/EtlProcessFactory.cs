...
namespace FileEtl.Core
{
    ...
    {
        public static List<IEtlStep> CreateEtlPipeline(Container container, List<ConfiguredEtlStep> etlSteps)
        {
        ...
        private static List<IEtlStep> CreateEtlPipeline(Container container, List<ConfiguredEtlStep> etlSteps, HashSet<Type> availableInputTypes)
        {
